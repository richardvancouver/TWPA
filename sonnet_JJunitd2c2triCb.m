JJunitd2c2triCb_xy={};
xx_=[-60000,-60000,-47997,-47997];
yy_=[7018,14100,14100,7018];
JJunitd2c2triCb_xy{end+1}={xx_,yy_};
xx_=[-42000,-42000,44000,44000,60000,60000,44000,44000];
yy_=[-99000,101000,101000,97014,97014,91018,91018,-99000];
JJunitd2c2triCb_xy{end+1}={xx_,yy_};
JJunitd2c2triCb_via_xy={};
xx_=[-55175,-55175,-48724,-48724];
yy_=[8024,13483,13483,8024];
JJunitd2c2triCb_via_xy{end+1}={xx_,yy_};
JJunitd2c2triCb_bridge_xy={};
xx_=[-42000,-42000,-60000,-60000,-42000,-42000,44000,44000];
yy_=[-99000,7014,7014,14095,14095,101000,101000,-99000];
JJunitd2c2triCb_bridge_xy{end+1}={xx_,yy_};
JJunitd2c2triCb_brick_xy={};
xx_=[-42000,-42000,44000,44000];
yy_=[-99000,101000,101000,-99000];
JJunitd2c2triCb_brick_xy{end+1}={xx_,yy_};
JJunitd2c2triCb_ports=[[59000.0, 95000.0], [-60000.0, 11000.0]];
JJunitd2c2triCb_boxsize=[120000, 250000];
JJunitd2c2triCb_sweep=[6, 8, 0.006666666666666667];
project_name_='JJunitd2c2triCb';
%%
%{
% data demo
JJunitd2c2triCb_xy={};
...
JJunitd2c2triCb_xy{end+1}={xx_,yy_};
JJunitd2c2triCb_ports=[[-250000,-20000], [250000,-20000]];
JJunitd2c2triCb_boxsize=[500000, 500000];
JJunitd2c2triCb_sweep=[4, 8, 2];
project_name_='JJunitd2c2triCb';
%}
%CPWs, circuits
% JJunitd2c2triCb_xy={};
...
% JJunitd2c2triCb_boxsize=[500000, 500000];
% JJunitd2c2triCb_sweep=[4, 8, 2];
% project_name_='JJunitd2c2triCb_mmbricviac';
%%
%%
%JJunitd2c2triCb_via_xy
% JJunitd2c2triCb_via_xy={};
...
unitratio_=0.001;
JJunitd2c2triCb_boxsize=JJunitd2c2triCb_boxsize*unitratio_;
Project.changeBoxSize(JJunitd2c2triCb_boxsize(1),JJunitd2c2triCb_boxsize(2));
...
%
offset_=JJunitd2c2triCb_boxsize/2;
JJunitd2c2triCb_polygon={};
for ii = JJunitd2c2triCb_xy
    xx_=ii{1}{1}*unitratio_+offset_(1);
    yy_=ii{1}{2}*unitratio_+offset_(2);
    JJunitd2c2triCb_polygon{end+1}=Project.addMetalPolygonEasy(1,xx_,yy_);
    Project.changePolygonType(JJunitd2c2triCb_polygon{end},'Lossless');
end
...
JJunitd2c2triCb_ports=JJunitd2c2triCb_ports*unitratio_;
portnum_=0;
for ii = 2:2:size(JJunitd2c2triCb_ports,2)
    portnum_=portnum_+1;
    Project.addPortAtLocation(JJunitd2c2triCb_ports(ii-1)+offset_(1),JJunitd2c2triCb_ports(ii)+offset_(2));
end
...
%%add via polygons%%
JJunitd2c2triCb_via_polygon={};
for ii = JJunitd2c2triCb_via_xy
    xx_=ii{1}{1}*unitratio_+offset_(1);
    yy_=ii{1}{2}*unitratio_+offset_(2);
    JJunitd2c2triCb_via_polygon{end+1}=Project.addViaPolygonEasy(1,0,xx_,yy_);
    Project.changePolygonType(JJunitd2c2triCb_via_polygon{end},'Lossless');
end
%Project.openInSonnet();

%%%%%
%%add brick polygons%%
JJunitd2c2triCb_brick_polygon={};
for ii = JJunitd2c2triCb_brick_xy
    xx_=ii{1}{1}*unitratio_+offset_(1);
    yy_=ii{1}{2}*unitratio_+offset_(2);
    JJunitd2c2triCb_brick_polygon{end+1}=Project.addDielectricBrickEasy(1,xx_,yy_,'Stream3:0');  %try addDielectricBrickEasy .addDielectricBrickEasy(0,[5,10,10,5,5],[10,10,20,20,10],'Brick1')
    %Project.changePolygonType(JJunitd2c2triCb_via_polygon{end},'Lossless');
end
%Project.openInSonnet();
...
%%add bridge polygons%%
JJunitd2c2triCb_bridge_polygon={};
for ii = JJunitd2c2triCb_bridge_xy
    xx_=ii{1}{1}*unitratio_+offset_(1);
    yy_=ii{1}{2}*unitratio_+offset_(2);
    JJunitd2c2triCb_bridge_polygon{end+1}=Project.addMetalPolygonEasy(0,xx_,yy_);
    Project.changePolygonType(JJunitd2c2triCb_bridge_polygon{end},'Lossless');
end
%Project.openInSonnet();
...
%Abs
%
%Project.addSimpleFrequencySweep(JJunitd2c2triCb_sweep(1),JJunitd2c2triCb_sweep(2),JJunitd2c2triCb_sweep(3));
Project.addAbsFrequencySweep(JJunitd2c2triCb_sweep(1),JJunitd2c2triCb_sweep(2));
...
JJunitd2c2triCb_Project=Project;
Project.simulate('-c');
